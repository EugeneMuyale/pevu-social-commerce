...
private fun UserProfile.toResponse() = UserProfileResponse(
    id, userId, fullName, username, bio, role, phoneNumber, avatarUrl, dateJoined, createdAt, updatedAt,
...
private fun ShippingAddress.toResponse() = ShippingAddressResponse(
    id, street, city, state, postalCode, country, phoneNumber, isDefault, createdAt, updatedAt
) 